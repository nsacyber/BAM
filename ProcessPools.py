...
class CabMgr(threading.Thread):
    ...
    '''
    def __init__(self, pdir: str, dest: str, poolsize: int, pemgr, psfxmgr, db, local: bool, globqueue):
    ...
    @classmethod
    def extracttask(cls, src, dst) -> Tuple:
        ...
        while not cabqueue.empty():
            ...
            listing = (cls.performcablisting(cabfile, cablogger)).decode("ascii")
...
class PSFXMgr(CabMgr):
    ...
    @classmethod
    def PSFXExtract(cls, src, dest, basedir, version):
        # procesing code
